    ...
    <table class="content-table">
      ...
      <tbody>
        ...
        while ($row = $query->fetch()) {
          ...
          $queryss = $pdoConnect2->prepare("SELECT COUNT(*) FROM invoice WHERE customer LIKE '$name'");
          $queryss->execute();
          ...
          $querys = $pdoConnect2->prepare("SELECT MAX(date) FROM invoice WHERE customer LIKE '$name'");
          $querys->execute();
          ...
          $querys = $pdoConnect2->prepare("SELECT MIN(date) FROM invoice WHERE customer LIKE '$name'");
          $querys->execute();
