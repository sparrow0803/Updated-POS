...
<section class="home" style="position: fixed; overflow: auto;">
  ...
  <h1><i class="bx bxs-package icon">&nbsp</i> INVENTORY HISTORY </h1>
   <h2><i class="bx bxs-user usericon">&nbsp</i> <?php echo htmlspecialchars($userrole); ?></h2>
  </div>

  <div class="dropdown1">
    <span class="inventory"> HISTORY ></span>
    <div class="dropdown-content1" id="myDropdown1">
        <a class="content1" href="inventoryhistory.php">In</a>
        <a class="content1" href="outboundIH.php">Out</a>
    </div>
</div>
<div class="table1">
  <h1 class="header">INVENTORY HISTORY OUTBOUND</h1>
  <div class="tabbox1">
  <table>
    <tr>
      <th>ID</th>
