...
$pdf = new FPDF('P','mm',array(58, 3276));
...
$pdf->Cell(20	,5,'Receipt Generated',0,0);
...
$pdf->Cell(28	,5,'Product',0,0);
$pdf->Cell(10	,5,'Qty',0,0);
$pdf->Cell(10	,5,'Prc',0,1);//end of line
...
$pdf->SetFont('Arial','',5);
	...
	foreach($result5 as $row5){
		$pdf->Cell(20, 5, $row5['product'], 0, 0);
		$pdf->Cell(12, 5, $row5['quantity'], 0, 0, 'R') ;
		$pdf->Cell(11, 5, $row5['price'], 0, 1, 'R');
	}


//summary
$pdf->Cell(20	,3,'',0,0);
$pdf->Cell(10	,3,'Subtotal',0,0);
$pdf->Cell(3	,3,'P',1,0);
$pdf->Cell(10	,3,$row4['subtotal'],1,1,'R');//end of line

$pdf->Cell(20	,5,'',0,0);
$pdf->Cell(10	,5,'Discount',0,0);
$pdf->Cell(3	,5,'P',1,0);
